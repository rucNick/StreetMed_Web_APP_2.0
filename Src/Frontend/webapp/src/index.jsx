          ...
          {!showIframe ? (
            <>
              ...
              <div style={styles.steps}>
                ...
                <div style={styles.step}>
                  ...
                  <span>In the frame, click "Advanced" ‚Ü?"Proceed to localhost"</span>
                </div>
                <div style={styles.step}>
              ...
              <div style={styles.actions}>
                ...
                <button 
                  ...
                  onClick={() => window.open(certTestUrl, '_blank')}
                >
            ...
            <>
              <div style={styles.iframeInstruction}>
                <strong>üëá Accept the certificate below:</strong><br/>
                Click "Advanced" ‚Ü?"Proceed to localhost (unsafe)"
              </div>
  ...
  useEffect(() => {
    const initSecurity = async () => {
      try {
        ...
        console.log(storedUser && storedSessionId 
